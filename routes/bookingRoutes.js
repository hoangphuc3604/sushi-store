...
router.post("/table", authMiddleware(["customer"]), bookingController.tableBooking);
...
router.post("/cart/checkout", authMiddleware(["customer"]), bookingController.cartCheckout);
